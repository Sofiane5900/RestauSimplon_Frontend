...
const CreateArticles = () => {
    ...
    return (
        <div className="flex flex-col items-center poppins">
            <h1 className="text-2xl mb-4 text-red-500 mt-6">Ajouter un article au menu</h1>
            <form onSubmit={postArticles} className="flex flex-col gap-4 w-full max-w-md">
                <input
                    type="text"
                    name="nom"
                    value={article.nom}
                ...
                <button type="submit" className="bg-red-600 text-white p-2 rounded">Ajouter</button>
            </form>
        </div>
    );
};
